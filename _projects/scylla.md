...
I pioneered a new method for turning stellar extinctions into total column density 2D extinction maps {% cite lindberg2026 %}. These maps allow us to trace the parsec-scale structure of the ISM across gas phases, providing some of the highest resolution maps of the ISM ever in external galaxies, independent of systematics associated with standard dust emission tracers.
